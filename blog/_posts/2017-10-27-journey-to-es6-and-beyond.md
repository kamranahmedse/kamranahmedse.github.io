...
ESNext is a dynamic name that refers to whatever the current version of ECMAScript is at any time. For example at the time of this writing `ES2017` or `ES8` is `ESNext`.
